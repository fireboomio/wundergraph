...
require moul.io/http2curl/v2 v2.3.0 // indirect
...
replace (
	...
	github.com/wundergraph/graphql-go-tools => github.com/fireboomio/graphql-go-tools v0.0.0-20240421115531-0f22a3c5095c
)
