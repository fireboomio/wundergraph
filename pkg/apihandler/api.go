...
const (
	WgEnvCsrfSecret       = "FB_CSRF_TOKEN_SECRET"
	WgEnvHashKey          = "FB_SECURE_COOKIE_HASH_KEY"
	WgEnvBlockKey         = "FB_SECURE_COOKIE_BLOCK_KEY"
...
type Api struct {
	...
	OperationSchemas map[string]*OperationSchema
}

type OperationSchema struct {
	Variables         *openapi3.SchemaRef `json:"variables"`
	InternalVariables *openapi3.SchemaRef `json:"internal_variables,omitempty"`
	Response          *openapi3.SchemaRef `json:"response"`
	Definitions       openapi3.Schemas    `json:"-"`
}
